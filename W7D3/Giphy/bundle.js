...
var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(search) {
  return function (dispatch) {
    APIUtil.fetchSearchGiphys(search).then(function (successRes) {
      return dispatch(receiveSearchGiphys(successRes.data));
    });
  };
};
...
var GiphysIndex = function (_React$Component) {
  ...
  _createClass(GiphysIndex, [{
    ...
    value: function render() {
      var allItems = this.props.giphys.map(function (giphy) {
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('input', { value: this.state.searchTerm, onChange: this.handleInput }),
